...
Summary(pl):	Biblioteka do ≥±czenia dokumentÛw w GNOME
...
pozwalaj±cy im pracowaÊ ze z≥oøonymi dokumentami. DziÍki niemu moøna
np. osadziÊ arkusz kalkulacyjny i grafikÍ w dokumencie edytora tekstu.
...
Summary(pl):	Pliki nag≥Ûwkowe biblioteki libbonobo
...
korzystaj±cych z modelu dokumentÛw libbonobo.
